...
/*
 * other emp variable :
jobNametxtfieldother * --
jobstarttimingcomboxBother  *--
jobEndtimingcomboxother  * --
SalarytextFieldother	*	--


faculty emp vairable:

jobNametxtfield * --
jobstarttimingcomboBoxfaculty * --
jobEndtimingcomboBoxfaculty   * --
SalarytextFieldfaculty	 	*--
selectcourse7       * --
Batch_start_time7   * --
Batch_End_time7     * --
								 				...
								 				validation.selectImage(frame);
								 				 ...
								 				 Address.setBounds(14, 164, 313, 85);
								 				  ...
								 				  state.setColumns(10);
								 				  		...
								 				  		email_id.addKeyListener(new KeyAdapter() {
								 				  			@Override
