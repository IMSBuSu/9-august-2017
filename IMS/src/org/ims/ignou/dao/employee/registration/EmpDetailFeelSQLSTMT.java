...
public class EmpDetailFeelSQLSTMT {
	...
	public PreparedStatement setQuflicationOther(Registration regFrame,PreparedStatement pre,Employeedto employeedetail,int employeeeid){	
		try{
	...
	public PreparedStatement setQuflicationUnderGraduate(Registration regFrame,PreparedStatement pre,Employeedto employeedetail,int employeeeid){	
		try{
	...
	public PreparedStatement setQuflicationPostGraduate(Registration regFrame,PreparedStatement pre,Employeedto employeedetail,int employeeeid){	
				try{
	...
	public PreparedStatement setQuflicationDiploma(Registration regFrame,PreparedStatement pre,Employeedto employeedetail,int employeeeid){	
				try{
	...
	public PreparedStatement setQuflicationCertification(Registration regFrame,PreparedStatement pre,Employeedto employeedetail,int employeeeid){
	...
	public PreparedStatement setQuflication12th(PreparedStatement pre,Employeedto employeedetail,int employeeeid){
		try {
	...
	public PreparedStatement setQuflication10th(PreparedStatement pre,Employeedto employeedetail,int employeeeid){
		try {
